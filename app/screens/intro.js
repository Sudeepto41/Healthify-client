...
import { StyleSheet, Text, View, Image, ImageBackground, Dimensions, TouchableOpacity, TouchableWithoutFeedback } from 'react-native';
...
export default function Intro() {
    return (
        ...
        <View style={styles.container}>
            ...
            <TouchableWithoutFeedback onPress={() => console.log('saxx')} style={{ alignItems: 'center' }}>
